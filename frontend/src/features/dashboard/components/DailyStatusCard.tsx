      ...
      <div className="flex items-center justify-between gap-3">
        <div>
          ...
          <div className="mt-2 flex items-baseline gap-1">
            <span className="text-2xl font-bold text-stone-900 dark:text-stone-50">{status.dailyScore}</span>
...
function StatusLine({ label, value }: { label: string; value: boolean }) {
  ...
  return (
    <div className="flex items-center justify-between gap-3 rounded-lg bg-stone-50 px-3 py-2 dark:bg-stone-800">
      <span className="text-stone-600 dark:text-stone-200">{label}</span>
